...
<head>
    ...
    <style>
        body {
            background-color:rgb(255, 255, 255); /* Color de fondo del diseño */
            color: white;
            margin: 0;
            padding: 0;
        ...
        .card {
            background-color:rgb(156, 22, 22); /* Color rojo para las tarjetas */
            border: none;
            color: white;
        }
        .card-title {
        ...
        <div class="row">
            <div class="col-md-4 mb-4">
                <div class="card text-center">
                    <img src="images/luis.jpg" class="card-img-top rounded-circle mx-auto mt-3" alt="Foto integrante" style="width: 150px; height: 150px;">
                    <div class="card-body">
